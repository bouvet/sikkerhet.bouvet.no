...
## Workflows 
Workflows kjøres på Github, og kan trigges av ulike hendelser som pushing av kode, i forbindelse med pull requests, tags og annet. En workflow kan bestå av en rekke jobber som igjen kan bestå av en rekke steg, hvert steg kan referere til en action. Workflowene brukes for å kjøre "noe" i forbindelse med disse eventene; i forkant av en pull request kan en eksempelvis kjøre en rekke tester for å se at endringene ikke brekker eksisterende funksjonalitet, før det kjøres en ny workflow etter merge til main som bygger og deployer koden. 
